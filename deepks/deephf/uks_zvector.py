...
class UKSDeePHFZVectorGradients(UHFDeePHFZVectorGradients):
    ...
    def _reset_results(self) -> None:
        ...
        self.correction_gradient_adjoint_fixed_grid_spin = None
        self.correction_gradient_adjoint_grid_coordinate_spin = None
        self.correction_gradient_adjoint_grid_weight_spin = None
    ...
    def _kernel(self) -> dict:
        ...
        shape = (self.mol.natm, 3)
        spin_shape = (2, self.mol.natm, 3)
        arrays = {

...
Run: `protocol_repair_failed8_20260825`
...
| L1-def2-TZVP | rhf | 2.553e-14 | 2.388e-07 | 1.23e-07 | 1.212e-05 | False |
...
| L1-def2-TZVP | rhf | 0.001 | 2.388e-07 | atom 6 x | 1.212e-05 | atom 0 x; q[0,2] | 1.23e-07 | 2 | False |
...
- `scientific` `L1-def2-TZVP` `rhf`: acceptance check failed: finite_difference_descriptor
...
uv run python validation/scientific_performance/scripts/run_campaign.py --run-root /home/mwding/WorkSpace/Projects/deepks-kit/diagnostics/scientific_performance/runs/protocol_repair_failed8_20260825
uv run python validation/scientific_performance/scripts/aggregate.py /home/mwding/WorkSpace/Projects/deepks-kit/diagnostics/scientific_performance/runs/protocol_repair_failed8_20260825
```
